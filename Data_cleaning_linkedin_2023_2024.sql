/* The main objective of this script is to analyze the data from nile’s LinkedIn page from June 2023 to June 2023. All data present here was exported directed from LinkedIn platform. 
 ...
 There are 6 tables in this schema
	content_id: Contains data such as likes, reactions, etc. from nile’s LinkedIn page in the last year
	content_posts: Contains data for every content posted on nile’s LinkedIn page in the last year
	followers_new: Contains data about new followers of nile’s LinkedIn page in the last year
	followers_secteur: Contains data about new followers of nile’s LinkedIn page in the last year by sector
	visits_stats: Contains data about visitors of nile’s LinkedIn page in the last year
	visits_secteur: Contains data about visitors of nile’s LinkedIn page in the last year by sector
